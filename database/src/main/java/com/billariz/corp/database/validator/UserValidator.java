...
{
    public UserValidator(ParameterRepository parameterRepository)
    {
    ...
    public void validate(Object target, Errors errors)
    {
        ...
        checkLanguageCode(i.getDefaultLanguage(), errors);
        checkUserRole(i.getUserRole(), errors);
        checkTitleCode(i.getIndividual().getTitleCode(), errors);
    }
}
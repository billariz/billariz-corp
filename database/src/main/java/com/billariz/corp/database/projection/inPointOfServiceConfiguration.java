...
@Projection(name = "inPointOfServiceConfiguration", types = { PointOfServiceConfiguration.class })
public interface inPointOfServiceConfiguration {
    Long      getId();
    ...
    String                            getReadingPeriode();

    String                            getBusinessGridCode();

    String                            getMarketGridCode();

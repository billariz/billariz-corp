...
@Component
public class MeterReadDetailValidator extends BaseValidator
{

    public MeterReadDetailValidator(ParameterRepository parameterRepository)
    {
    ...
    {
        return MeterReadDetail.class.equals(clazz);
    }

    @Override
    public void validate(Object target, Errors errors)
    {
        var i = (MeterReadDetail) target;
        
        checkSqType(i.getUnit(), errors);
        checkTou(i.getTou(), errors);
        checkMeasureType(i.getMeasureType(), errors);

...
@Component
public class ServiceElementTypeValidator extends BaseValidator
{
    public ServiceElementTypeValidator(ParameterRepository parameterRepository)
    {
    ...
    {
        return ServiceElementType.class.equals(clazz);
    }

    @Override
    public void validate(Object target, Errors errors)
    {
        var i = (ServiceElementType) target;
